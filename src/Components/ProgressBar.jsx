export default function ProgressCard({ title, value, total }) {
  ...
  return (
    <div className=" w-full  rounded-2xl overflow-hidden text-white shadow-neutral-600 shadow-md p-6 ">
      <h3 className="text-md font-semibold goldTxt mb-3 text-center">{title}</h3>
      
      <div className=" bgSecondary rounded-full h-4 overflow-hidden">
        <div
